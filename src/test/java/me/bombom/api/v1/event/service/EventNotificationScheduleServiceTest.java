...
class EventNotificationScheduleServiceTest {
    ...
    void 이벤트_알림_스케줄을_생성한다() {
        ...
        assertSoftly(softly -> {
            ...
            softly.assertThat(schedules.getFirst().getType()).isEqualTo(NotificationScheduleType.BEFORE_MINUTES);
        });
    }
    ...
    void 이벤트_알림_스케줄_목록을_조회한다() {
        ...
        scheduleRepository.save(EventNotificationSchedule.builder()
                .eventId(event.getId())
        ...
        scheduleRepository.save(EventNotificationSchedule.builder()
                ...
                .type(NotificationScheduleType.AT_START)
                .minutesBefore(null)
                .build());
    ...
    void 이벤트_단일_알림_스케줄을_조회한다() {
        ...
        EventNotificationSchedule schedule = scheduleRepository.save(EventNotificationSchedule.builder()
                .eventId(event.getId())
                .scheduledAt(LocalDateTime.now().plusMinutes(5))
                .type(NotificationScheduleType.BEFORE_MINUTES)
                .minutesBefore(5)
        ...
        // when
        GetEventNotificationScheduleResponse response = scheduleService.getSchedule(event.getId(), schedule.getId());

...
public class HolidayController implements HolidayControllerApi {
    ...
    @Override
    @GetMapping
    public List<GetHolidayResponse> getHolidays(@ModelAttribute GetHolidaysRequest request) {
    ...
    @PostMapping("/batch")
    @ResponseStatus(HttpStatus.CREATED)
    public void createHolidays(@Valid @RequestBody CreateHolidaysRequest request) {
